...
- #### Receive echo reply
  ...
  When this value is reached without receiving any message from remote server, the program prints "Request timed out!" and exit the function.
  - The time of receiving the message will be captured by the function. RTT value can then be calculated by subtracting sending time from receiving time.
  -  
