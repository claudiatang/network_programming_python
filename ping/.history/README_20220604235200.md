### Introduction
- This [ping.py](https://github.com/claudiatang/network_programming_python/blob/main/ping/ping.py) script aims to carry out a study on ICMP packet anatomy and ping , rather than fully replicating the ```ping``` utility command in Linux terminal or CMD
- Learning objectives:
