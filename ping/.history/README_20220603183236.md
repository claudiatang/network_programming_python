...
- #### Calculate checksum
  ...
  - The function also takes in consideration different [endianness]("https://getkt.com/blog/endianness-little-endian-vs-big-endian/") (byte orders) of different computer systems. This decide the order of which the program append two bytes together. The endianness information is obtained by ```sys.byteorder```
