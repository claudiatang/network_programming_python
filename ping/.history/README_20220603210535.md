...
- #### Receive echo reply
  ...
  - If a message is received before time out, the time of receiving the message will be captured by the function. RTT value can then be calculated by subtracting sending time from receiving time.
  -  
