### Introduction
- This [ping.py](https://github.com/claudiatang/network_programming_python/blob/main/ping/ping.py) script aims to ... , rather than fully replicating the ```ping``` utility command 
- Learning objectives:
