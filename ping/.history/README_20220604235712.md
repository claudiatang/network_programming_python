### Introduction
- This [ping.py](https://github.com/claudiatang/network_programming_python/blob/main/ping/ping.py) script aims to carry out a study on layer 3 PDU anatomy and the ping functionality, rather than fully replicating the ```ping``` command and its various flags in Linux terminal or CMD
- Learning objectives:
...
&emsp;&emsp;The command format for pinging a remote server from CMD is:\
