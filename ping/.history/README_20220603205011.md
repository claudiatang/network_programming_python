...
- #### Receive echo reply
  ...
  - If the program receives an ICMP message, the time of receiving the message will be captured by the function. RTT value can then be calculated by subtracting sending time from receiving time.
  -  
