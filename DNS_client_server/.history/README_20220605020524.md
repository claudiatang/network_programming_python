...
&emsp;&emsp;This refers to whether the I/O function of a socket block the execution of other tasks.
&emsp;&emsp;Here is a brilliant article [Understanding Non Blocking I/O with Python — Part 1](https://medium.com/vaidikkapoor/understanding-non-blocking-i-o-with-python-part-1-ec31a2e2db9b) on blocking/non-blocking I/O using TCP socket as example.
