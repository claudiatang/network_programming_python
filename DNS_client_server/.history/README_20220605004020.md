...
- The DNS server program, once receiving a queried host name from a client, is responsible for querying ... by calling the [```socket.getaddrinfo()```](https://docs.python.org/3/library/socket.html#socket.getaddrinfo) function
